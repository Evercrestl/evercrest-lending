...
// components/ResetPasswordClient.jsx
"use client";
...
export default function ResetPasswordClient() {
    ...
    const verifyToken = async (tokenToVerify) => {
        try {
            ...
            if (tokenToVerify && tokenToVerify.length === 64) {
                setTokenValid(true);
            } else {
                setTokenValid(false);
            }
            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-8 space-y-6">
                    {!resetSuccess ? (
                        <>
                            <div className="text-center space-y-2">
                                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-500 rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-blue-600/30">
                                    <Lock className="w-8 h-8 text-white" />
                                </div>
                                <h1 className="text-2xl font-bold text-slate-800">
                                    Reset Your Password
